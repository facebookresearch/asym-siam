...
parser.add_argument(
    "--lars",
    action="store_true",
    help="Use LARS instead of SGD to perform optimization",
)
parser.add_argument(
    "--pretrained",
    default="",
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.distributed:
        ...
        # DataParallel divides and allocates batch_size to all available GPUs
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if not args.multiprocessing_distributed or (
            ...
            save_checkpoint(
                ...
                is_best,
                filename=f"checkpoint_{args.tag}.pth.tar"
            )
...
def sanity_check(state_dict, pretrained_weights):
    """
    Linear classifier should not change any weights other than the linear
    layer. This sanity check asserts nothing wrong happens (e.g., BN stats
    updated).
    """
